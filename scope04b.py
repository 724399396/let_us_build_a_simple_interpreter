...
(INTEGER, PLUS, MINUS, MUL, LPAREN, RPAREN, EOF, ID, ASSIGN, SEMI, DOT, BEGIN, END, PROGRAM, VAR, COLON, COMMA, REAL, INTEGER_CONST, REAL_CONST, INTEGER_DIV, FLOAT_DIV, PROCEDURE) = (
    'INTEGER', 'PLUS', 'MINUS', 'MUL', '(', ')', 'EOF', 'ID', 'ASSIGN', 'SEMI', 'DOT', 'BEGIN', 'END', 'PROGRAM', 'VAR', 'COLON', 'COMMA', 'REAL', 'INTEGER_CONST', 'REAL_CONST', 'INTEGER_DIV', 'FLOAT_DIV', 'PROCEDURE'
)
